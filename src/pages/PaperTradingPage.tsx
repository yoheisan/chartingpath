...
export default function PaperTradingPage() {
  ...
  return (
    <div className="container mx-auto px-4 md:px-6 lg:px-8 py-6 space-y-6">
      <PageMeta
        title={t('paperTrading.seoTitle', 'Paper Trading — ChartingPath')}
        description={t('paperTrading.seoDesc', 'Practice trading with zero risk. Paper trade chart patterns and track simulated performance with real market data.')}
        canonicalPath="/tools/paper-trading"
      />
