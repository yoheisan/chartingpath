      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <div className="mt-8 flex flex-col items-center gap-4">
            ...
            <div className="flex items-center gap-2 px-4 py-2 rounded-full border border-primary/20 bg-primary/5 text-sm">
              ...
              <span className="text-foreground font-medium">{p('moneyBackGuarantee', '14-day money-back guarantee')}</span>
              <span className="text-muted-foreground">· {p('noQuestionsAsked', 'No questions asked')}</span>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mb-16">
          <p className="text-sm text-muted-foreground flex items-center justify-center gap-2">
            <ShieldCheck className="h-4 w-4 text-primary" />
            {p('allPlansGuarantee', 'All paid plans include a')} <strong className="text-foreground">{p('moneyBackGuarantee', '14-day money-back guarantee')}</strong>. {p('cancelAnytime', 'Cancel anytime, no questions asked.')}
          </p>
        </div>
