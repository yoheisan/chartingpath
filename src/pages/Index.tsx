        ...
        <div className="relative z-10 container mx-auto px-4 md:px-6 lg:px-8 py-20 lg:py-28">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl lg:text-[1.35rem] text-muted-foreground mb-10 max-w-xl animate-fade-in leading-relaxed" style={{ animationDelay: '0.1s' }}>
              {t('landing.heroSubheadline', { defaultValue: `ChartingPath detects chart patterns live across FX and US equities — and tracks every outcome. Win rates, R-multiples, and outcome data from ${outcomeCount} pattern detections. Not textbook stats — real data from our engine.`, count: outcomeCount })}
            </p>
