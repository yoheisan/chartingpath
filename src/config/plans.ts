 ...
 * - Frontend: src/config/plans.ts (this file)
 * - Edge functions: supabase/functions/_shared/plans.ts
 * 
...
export const PLANS_CONFIG: PlansConfig = {
  tiers: {
    ...
    LITE: {
      ...
      maxConcurrentRuns: 1,
      maxActiveAlerts: 5,
      maxPlanAlerts: 5, // 5 per plan × 2 plans = 10 max
    ...
    PRO: {
      ...
      maxConcurrentRuns: 2,
      maxActiveAlerts: 100,
      maxPlanAlerts: 20, // 20 per plan × 10 plans = 200 max
