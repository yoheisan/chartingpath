...
## Parameter Reference & Reasoning

### Risk Per Trade (risk_r)
- **Default:** 2.0% | **Institutional Range:** 0.5–2.0%
- **Reasoning:** The Kelly Criterion suggests optimal sizing is edge/odds, but practitioners use fractional Kelly (¼–½) to reduce drawdown variance. Institutional desks typically cap single-trade risk at 0.5–2% of NAV. Risk >3% dramatically increases ruin probability even with positive expectancy.
- **References:** Vince, R. (1992). *The Mathematics of Money Management*; Tharp, V. (2006). *Trade Your Way to Financial Freedom*.

### Take Profit R:R (tp_rr)
- **Default:** 2.0 | **Institutional Range:** 1.5–3.0
- **Reasoning:** Bulkowski's *Encyclopedia of Chart Patterns* (3rd ed.) shows median pattern moves of 1.5–3.0× the pattern height. A minimum 2:1 R:R allows profitability at just 34% win rate. Higher ratios (3:1+) suit trend-following but reduce fill probability. Calibrate using your backtest win rate.
- **References:** Bulkowski, T. (2021). *Encyclopedia of Chart Patterns*, 3rd Ed.; Elder, A. (1993). *Trading for a Living*.

### Max Trades Per Day (max_trades_day)
- **Default:** 5 | **Institutional Range:** 3–8
- **Reasoning:** Trade frequency caps prevent overtrading during high-volatility regimes (NFP, FOMC). Research by Barber & Odean (2000) shows excessive trading erodes returns via commission drag and adverse selection.
- **References:** Barber, B. & Odean, T. (2000). *Trading Is Hazardous to Your Wealth*. Journal of Finance.

### Session Window (trade_start / trade_end)
- **Default:** 0000–2359 (full session)
- **Reasoning:** Market microstructure research shows the first 30–60 minutes exhibit wider spreads and higher volatility. Institutional traders often avoid the open, entering after 09:30–10:00 ET (equities) or the London open 08:00 GMT (FX). Liquidity thins 30–60 min before close, increasing fill risk.
- **References:** Hasbrouck, J. (2007). *Empirical Market Microstructure*; Aldridge, I. (2013). *High-Frequency Trading*.

### ATR Multiplier (atr_mult)
- **Default:** 2.0 | **Institutional Range:** 1.5–2.5
- **Reasoning:** Wilder's ATR measures realized volatility over N periods. A 2.0× multiplier places the stop ~2 standard-deviation-equivalents from entry, filtering normal noise while catching genuine reversals. Keltner Channels use 1.5×; Chandelier Exits default to 3.0×. Lower values (1.0–1.5) suit scalping; higher (2.5–4.0) suit swing trading.
- **References:** Wilder, J.W. (1978). *New Concepts in Technical Trading Systems*; Kaufman, P. (2013). *Trading Systems and Methods*, 5th Ed.

### Directional Filters (use_long / use_short)
- **Reasoning:** In confirmed downtrends (price below 200 EMA, ADX trending down), disabling longs reduces whipsaw losses. Bulkowski's data shows bullish pattern failure rates increase 15–25% in bear markets. Short-selling carries asymmetric risk and higher costs (borrowing fees, uptick rules).
- **References:** Bulkowski, T. (2021). *Encyclopedia of Chart Patterns*, 3rd Ed.; Asness, C. et al. (2004). *Short-Selling*. Institutional Investor.
