  ...
  return (
    <div className="space-y-3">
      <h3 className="text-lg font-semibold flex items-center gap-2">
        ...
        How this pattern performs on ChartingPath
      </h3>
      <Card className="p-4 bg-gradient-to-br from-primary/5 to-transparent border-primary/20">
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="text-center p-3 rounded-lg bg-background/50 border">
            ...
            <div className="text-xs text-muted-foreground mt-1">Avg R-multiple to TP</div>
          </div>
          <div className="text-center p-3 rounded-lg bg-background/50 border">
            <div className="text-2xl font-bold text-foreground">{stats.avgBars}</div>
            <div className="text-xs text-muted-foreground mt-1">Avg bars to resolution</div>
          </div>
          <div className="text-center p-3 rounded-lg bg-background/50 border">
        ...
        {stats.liveSetupsCount > 0 && (
          <div className="mt-3 pt-3 border-t text-sm">
            ...
            >
              Live setups right now: {stats.liveSetupsCount}
