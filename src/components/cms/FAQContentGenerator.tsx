...
const buildServiceRegistry = (): ServiceDefinition[] => [
  ...
  },
  {
    ...
    category: "learning",
    shortDescription: "Every pattern, timeframe and asset combination we track — winners and losers alike.",
    faqs: [
      { q: "What is the outcome data table?", a: "It lists every pattern, timeframe and asset combination we have resolved outcomes for — including the ones with negative expectancy. Win rate, expectancy and sample size are shown on every row." },
      { q: "Why is there no ranking?", a: "Train/test correlation on cell expectancy is 0.181, so ordering cells by expectancy would imply a precision the data does not have. We show the full table with sample sizes instead." },
    ...
    hashtags: ["#OutcomeData", "#TradingEdge", "#PatternStats"],
  },
  {
    id: "pattern-library",
