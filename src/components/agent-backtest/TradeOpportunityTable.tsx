...
// Mock trade opportunities representing a realistic scan
const MOCK_TRADES: TradeOpportunity[] = [
  { id: '1', symbol: 'AAPL', pattern: 'Bull Flag', direction: 'Long', timeframe: '1D', entryPrice: 189.50, stopLoss: 185.20, takeProfit: 198.40, rr: 2.1, analystRaw: 0.92, riskRaw: 0.88, timingRaw: 0.75, portfolioRaw: 0.80 },
  { id: '2', symbol: 'MSFT', pattern: 'Ascending Triangle', direction: 'Long', timeframe: '4H', entryPrice: 415.00, stopLoss: 408.50, takeProfit: 432.00, rr: 2.6, analystRaw: 0.85, riskRaw: 0.72, timingRaw: 0.80, portfolioRaw: 0.65 },
  { id: '3', symbol: 'TSLA', pattern: 'Head & Shoulders', direction: 'Short', timeframe: '1D', entryPrice: 245.00, stopLoss: 258.00, takeProfit: 218.00, rr: 2.1, analystRaw: 0.60, riskRaw: 0.45, timingRaw: 0.55, portfolioRaw: 0.70 },
  { id: '4', symbol: 'NVDA', pattern: 'Cup & Handle', direction: 'Long', timeframe: '1W', entryPrice: 875.00, stopLoss: 840.00, takeProfit: 950.00, rr: 2.1, analystRaw: 0.95, riskRaw: 0.82, timingRaw: 0.60, portfolioRaw: 0.40 },
  { id: '5', symbol: 'META', pattern: 'Double Bottom', direction: 'Long', timeframe: '1D', entryPrice: 505.00, stopLoss: 492.00, takeProfit: 535.00, rr: 2.3, analystRaw: 0.78, riskRaw: 0.90, timingRaw: 0.85, portfolioRaw: 0.75 },
  { id: '6', symbol: 'AMZN', pattern: 'Descending Wedge', direction: 'Long', timeframe: '4H', entryPrice: 185.50, stopLoss: 180.00, takeProfit: 196.00, rr: 1.9, analystRaw: 0.72, riskRaw: 0.68, timingRaw: 0.40, portfolioRaw: 0.85 },
  { id: '7', symbol: 'GOOGL', pattern: 'Bear Flag', direction: 'Short', timeframe: '1D', entryPrice: 152.00, stopLoss: 157.50, takeProfit: 140.00, rr: 2.2, analystRaw: 0.55, riskRaw: 0.50, timingRaw: 0.30, portfolioRaw: 0.60 },
  { id: '8', symbol: 'AMD', pattern: 'Inv Head & Shoulders', direction: 'Long', timeframe: '1D', entryPrice: 165.00, stopLoss: 158.00, takeProfit: 182.00, rr: 2.4, analystRaw: 0.88, riskRaw: 0.75, timingRaw: 0.70, portfolioRaw: 0.55 },
  { id: '9', symbol: 'JPM', pattern: 'Bull Pennant', direction: 'Long', timeframe: '1D', entryPrice: 198.00, stopLoss: 193.00, takeProfit: 210.00, rr: 2.4, analystRaw: 0.82, riskRaw: 0.92, timingRaw: 0.65, portfolioRaw: 0.90 },
  { id: '10', symbol: 'BTC/USD', pattern: 'Donchian Breakout', direction: 'Long', timeframe: '1H', entryPrice: 67500, stopLoss: 65800, takeProfit: 71200, rr: 2.2, analystRaw: 0.70, riskRaw: 0.55, timingRaw: 0.15, portfolioRaw: 0.50 },
  { id: '11', symbol: 'ETH/USD', pattern: 'Symmetrical Triangle', direction: 'Long', timeframe: '4H', entryPrice: 3450, stopLoss: 3320, takeProfit: 3720, rr: 2.1, analystRaw: 0.65, riskRaw: 0.60, timingRaw: 0.45, portfolioRaw: 0.35 },
  { id: '12', symbol: 'SPY', pattern: 'Rising Wedge', direction: 'Short', timeframe: '1D', entryPrice: 510.00, stopLoss: 518.00, takeProfit: 494.00, rr: 2.0, analystRaw: 0.48, riskRaw: 0.40, timingRaw: 0.20, portfolioRaw: 0.55 },
];
