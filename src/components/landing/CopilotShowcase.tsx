...
import { FadeIn, SectionNum } from "@/components/editorial";
  ...
  return (
    <section className="py-20 px-4 md:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto">
        ...
        <FadeIn>
          <div className="mb-14">
            <SectionNum n="02" label={t('copilotShowcase.badge')} />
            <h2 className="text-3xl font-bold mt-4 mb-3">
              {t('copilotShowcase.title')}
            </h2>
            <p className="text-sm text-muted-foreground max-w-xl" dangerouslySetInnerHTML={{ __html: t('copilotShowcase.subtitle') }} />
          </div>
        </FadeIn>

        {/* 6-Card Moat Grid */}
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 mb-16">
          {moatFeatures.map((feature, i) => (
