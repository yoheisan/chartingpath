    ...
    <div className="flex flex-col flex-1 min-h-0">
      ...
      <div className="p-2 border-t border-border/40">
        <UniversalSymbolSearch
          ...
          trigger={
            <button className="w-full flex items-center gap-2 bg-muted/30 border border-border/40 rounded-md px-2.5 py-2 text-sm text-muted-foreground hover:border-primary/40 hover:text-foreground transition-colors">
