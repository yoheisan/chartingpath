            ...
            <div style="padding: 40px 20px;">
              ...
              <div style="background: linear-gradient(135deg, #f9f9f9 0%, #f3f4f6 100%); border-left: 4px solid #ff6633; padding: 16px; margin-bottom: 24px; border-radius: 4px;">
                <p style="margin: 0; font-size: 14px; color: #333; line-height: 1.8;">
                  <strong style="color: #ff6633;">📊 Markets:</strong> ${marketList}<br>
                  <strong style="color: #ff6633;">📅 Time Span:</strong> ${timeSpanText}<br>
                  <strong style="color: #ff6633;">🌍 Timezone:</strong> ${timezone}<br>
                  <strong style="color: #ff6633;">📝 Tone:</strong> ${tone.charAt(0).toUpperCase() + tone.slice(1)}
                </p>
              </div>
              ...
              <div style="margin-top: 32px; text-align: center; padding: 24px; background-color: #f9fafb; border-radius: 8px;">
                <a href="https://chartingpath.com" style="display: inline-flex; align-items: center; gap: 8px; padding: 12px 24px; background: linear-gradient(135deg, #ff6633 0%, #ff8000 100%); color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 14px;">
