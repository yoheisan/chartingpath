...
serve(async (req) => {
  ...
  try {
    ...
    if (post.post_type === 'market_report') {
      // Check if content was already pre-generated by the prepare-market-report-teasers cron job
      if (content && content.trim().length > 0) {
        console.log('Using pre-generated market report teaser');
      } else {
        console.log('No pre-generated content found, generating market report teaser now...');
