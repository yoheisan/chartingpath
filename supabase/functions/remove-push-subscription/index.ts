...
serve(async (req) => {
  ...
  try {
    ...
    if (deleteError) {
      console.error('[remove-push-subscription] Error removing subscription:', deleteError);
      throw deleteError;
    }

    console.log(`[remove-push-subscription] Removed subscriptions for user ${userId}`);
