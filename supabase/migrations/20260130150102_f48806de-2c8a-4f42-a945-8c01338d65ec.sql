-- Schedule daily historical pattern seeding (runs at 5 AM UTC)
SELECT cron.schedule(
  'seed-historical-patterns-daily',
  '0 5 * * *',
  $$
  SELECT
    net.http_post(
        url:='https://dgznlsckoamseqcpzfqm.supabase.co/functions/v1/seed-historical-patterns',
        ...
        body:='{"daysBack": 1, "assetTypes": ["fx", "crypto", "stocks", "commodities"]}'::jsonb
    ) as request_id;
  $$
);